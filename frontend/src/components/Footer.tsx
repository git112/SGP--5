export const Footer = () => {
  return (
    <footer className="relative bg-slate-900/95 border-t border-slate-800/50 backdrop-blur-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-12 h-12 rounded-xl bg-slate-800/80 hover:bg-cyan-500/20 border border-slate-700/50 hover:border-cyan-500/50 flex items-center justify-center text-slate-300 hover:text-cyan-400 transition-all duration-300 hover:scale-105">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-slate-300 hover:text-cyan-400 transition-colors duration-200 flex items-center group">
